...
class Odai {
  static OdaiTables = [
    { database: "bachelor_forum", table: "post", primaries: [] },
    { database: "bachelor_forum", table: "post_reply", primaries: [] },
    { database: "bachelor_forum", table: "post_view", primaries: [] },
  ];
  ...
  static config = {
    defaultDatabase: "bachelor_forum",
    appName: "mingle",
  };
