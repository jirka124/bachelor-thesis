...
<template>
  <div id="ask">
    ...
    <div class="ask-in-group">
      <input type="text" placeholder="The title of your question" class="in">
    ...
    <div class="ask-in-group">
      <textarea placeholder="The whole question" class="in"></textarea>
      <button><i class="fa-solid fa-question"></i></button>
    </div>
    <div class="ask-hint">
    ...
    <div>
      <button class="btn-1">Ask Question</button>
      <button class="btn-2">Have changed my mind, don't want to ask</button>
    </div>
  </div>
</template>
