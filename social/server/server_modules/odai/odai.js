...
class Odai {
  static OdaiTables = [
    { database: "bachelor_social", table: "friendship", primaries: [] },
    { database: "bachelor_social", table: "post", primaries: [] },
    { database: "bachelor_social", table: "post_comment", primaries: [] },
    { database: "bachelor_social", table: "post_like", primaries: [] },
    { database: "bachelor_social", table: "user", primaries: [] },
  ];
  ...
  static config = {
    defaultDatabase: "bachelor_social",
    appName: "soconnect",
  };
